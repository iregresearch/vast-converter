"""
Django settings for My VAST App project.
...
SECRET_KEY = env("SECRET_KEY", default="oHCZeHhzBGstdEGGDHJJDLVrPJoRrUWghrCyZdEA")
...
WSGI_APPLICATION = "vast_projet.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="vast_projet"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "vast_projet_language"
LANGUAGES = [
...
EMAIL_SUBJECT_PREFIX = "[My VAST App] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "My VAST App",
    "DESCRIPTION": "Video, Audio, Text and Speech Converter",
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("My VAST App"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Video, Audio, Text and Speech Converter"),
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "support@marys-team.com",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Shahzaib", "support@marys-team.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "vast_projet": {
            "handlers": ["console"],
            "level": env("VAST_PROJET_LOG_LEVEL", default="INFO"),
        },
    },
}
